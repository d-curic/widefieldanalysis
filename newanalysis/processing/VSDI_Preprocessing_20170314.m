...
clc
tic;
filelocation1 = '/media/dcuric/400CCB3D50C6D071/PhD/research/ADdata/5XFAD +ve AD 6 month/20180517/';
file1={[filelocation1 '02_spon_90000fr_100Hz_raw.raw'],[filelocation1 '09_spon_90000fr_100Hz_raw.raw']};

filelocation2 = '/media/dcuric/400CCB3D50C6D071/PhD/research/ADdata/5XFAD -ve Control 6 month/20180515/';
file2={[filelocation2 '03_spon_90000fr_100Hz_raw.raw'],[filelocation2 '09_spon_90000fr_100Hz_raw.raw']};

file = {file1{1}, file1{2},file2{1}, file2{2}};

endstring = '_spon_100Hz_90000FR_detrend_dff0_HPfiltered_05.raw.raw';
endstring = '_spon_100Hz_90000FR_detrend_dff0_BPfiltered_05_25Hz.raw.raw';

savenamefile1={['02' endstring],['09' endstring]};
savenamefile2={['03' endstring],['09' endstring]};

newfile = {[filelocation1 savenamefile1{1}], [filelocation1 savenamefile1{2}], [filelocation2 savenamefile2{1}], [filelocation2 savenamefile2{2}]};
...
Mask = imread('/media/dcuric/400CCB3D50C6D071/PhD/research/ADproject/analysis/masks/mouse2_Mask.tif','tiff');

filter_coefficients = load('Filter_FIT_05_25_100Hz_order400.txt');

%%

for fn=1:2;%length(file)
...
filename = file{fn};%[pathname, char(file(fn))]

['processing: ' filename]
['will save as: ' newfile{fn}]
...
% tic
'saving...'
filtered_file = newfile{fn};%[pathname, char(newfile(fn))];
